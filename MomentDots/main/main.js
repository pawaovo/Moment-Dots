...
// GitHub项目相关常量
const GITHUB_PROJECT_URL = 'https://github.com/pawaovo/Moment-Dots';
const GITHUB_TOOLTIP_TEXT = '访问GitHub项目页面';
...
function createPageContent() {
  ...
  root.innerHTML = `
    ...
    <div class="brand-footer">
      <a href="${GITHUB_PROJECT_URL}" target="_blank" class="brand-text brand-link" title="${GITHUB_TOOLTIP_TEXT}">
        MomentDots
      </a>
      <a href="${GITHUB_PROJECT_URL}" target="_blank" class="github-icon-link" title="${GITHUB_TOOLTIP_TEXT}">
        ${GITHUB_ICON_SVG}
      </a>
    </div>
  `;
